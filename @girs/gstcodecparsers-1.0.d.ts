...
declare module 'gi://GstCodecParsers?version=1.0' {
    ...
    export namespace GstCodecParsers {
        ...
        class H265Parser {
             ...
             * @returns a {@link GstCodecParsers.H265ParserResult}
             */
            parse_decoder_config_record(
                data: number,
                size: bigint | number,
            ): [H265ParserResult, H265DecoderConfigRecord];
            /**
             * This function should be called in the case one doesn't need to
             * parse a specific structure. It is necessary to do so to make
        ...
        class H266Parser {
            ...
            parse_decoder_config_record(
                data: number,
                size: bigint | number,
            ): [H266ParserResult, H266DecoderConfigRecord];
            /**
             * This function should be called in the case one doesn't need to
             * parse a specific structure. It is necessary to do so to make
             * sure `parser` is up to date.
        ...
        class Vp9Parser {
             ...
             * @returns a {@link GstCodecParsers.Vp9ParserResult}
             */
            parse_superframe_info(
                superframe_info: Vp9SuperframeInfo,
                data: number,
                size: bigint | number,
            ): Vp9ParserResult;
        }
